...
class NoteSequence(_message.Message):
    ...
    class SequenceMetrics(_message.Message):
        ...
        PITCH_RANGE_FIELD_NUMBER: _ClassVar[int]
        CONTOUR_FIELD_NUMBER: _ClassVar[int]
        UNIQUE_NOTES_RATIO_FIELD_NUMBER: _ClassVar[int]
        UNIQUE_BIGRAMS_RATIO_FIELD_NUMBER: _ClassVar[int]
        UNIQUE_TRIGRAMS_RATIO_FIELD_NUMBER: _ClassVar[int]
        DYNAMIC_RANGE_FIELD_NUMBER: _ClassVar[int]
        NOTE_CHANGE_RATIO_FIELD_NUMBER: _ClassVar[int]
        RATIO_NOTE_OFF_STEPS_FIELD_NUMBER: _ClassVar[int]
        RATIO_HOLD_NOTE_STEPS_FIELD_NUMBER: _ClassVar[int]
        REPETITIVE_SECTION_RATIO_FIELD_NUMBER: _ClassVar[int]
        LEN_LONGEST_REP_SECTION_FIELD_NUMBER: _ClassVar[int]
        toussaint: float
        note_density: float
        pitch_range: float
        contour: float
        unique_notes_ratio: float
        unique_bigrams_ratio: float
        unique_trigrams_ratio: float
        dynamic_range: float
        note_change_ratio: float
        ratio_note_off_steps: float
        ratio_hold_note_steps: float
        repetitive_section_ratio: float
        len_longest_rep_section: float
        def __init__(self, toussaint: _Optional[float] = ..., note_density: _Optional[float] = ..., pitch_range: _Optional[float] = ..., contour: _Optional[float] = ..., unique_notes_ratio: _Optional[float] = ..., unique_bigrams_ratio: _Optional[float] = ..., unique_trigrams_ratio: _Optional[float] = ..., dynamic_range: _Optional[float] = ..., note_change_ratio: _Optional[float] = ..., ratio_note_off_steps: _Optional[float] = ..., ratio_hold_note_steps: _Optional[float] = ..., repetitive_section_ratio: _Optional[float] = ..., len_longest_rep_section: _Optional[float] = ...) -> None: ...
